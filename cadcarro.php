                    ...
                    <div class="card-body">
                        <form action="cadcarros.php" method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="placa" placeholder="Digite a placa do carro." required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Modelo</label>
                                <input type="text" class="form-control" name="modelo" placeholder="Digite o modelo do carro." required>
                            </div>
